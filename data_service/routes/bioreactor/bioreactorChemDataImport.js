...
const model = 'BioreactorChemDataImport';
...
function searchByColumn (req, res) {
    ...
    db.BioreactorChemDataImport.findAll(criteria).then(function (BioreactorChemDataImport) {
        res.json(BioreactorChemDataImport);
